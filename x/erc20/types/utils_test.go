	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "Blockx",
				Symbol:      "BCX",
				Description: "EVM, staking and governance denom of blockx",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "abcx",
						Exponent: 0,
						Aliases:  []string{"atto blockx"},
					},
					{
						Denom:    "bcx",
						Exponent: 18,
				...
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "abcx",
						Exponent: 0,
						Aliases:  []string{"atto abcx"},
					},
					{
						Denom:    "ubcx",
						Exponent: 12,
						Aliases:  []string{"micro abcx"},
					},
					{
						Denom:    "abcx",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto abcx", "abcx"},
			[]string{"abcx", "atto abcx"},
			false,
		},
		{
			"same values, sorted",
