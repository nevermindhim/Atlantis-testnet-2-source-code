...
import (
	...
	"github.com/defi-ventures/bcx-testnet-7/x/inflation/types"
)
...
func (suite *KeeperTestSuite) TestPeriodChangesSkippedEpochsAfterEpochEnd() {
	...
	// supply is 10000000000 in tests
	supply := sdk.NewDec((suite.app.BankKeeper.GetSupply(suite.ctx, "atbcx").Amount.Int64()))
