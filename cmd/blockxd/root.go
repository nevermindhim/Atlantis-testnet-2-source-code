...
import (
	...
	cmdcfg "github.com/defi-ventures/bcx-testnet-7/cmd/config"
	blockxkr "github.com/defi-ventures/bcx-testnet-7/crypto/keyring"
)
...
// NewRootCmd creates a new root command for blockxd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(blockxkr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		blockxApp = app.NewBlockx(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := blockxApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		blockxApp = app.NewBlockx(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return blockxApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
