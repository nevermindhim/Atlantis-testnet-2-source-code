...
func InitCmd(mbm module.BasicManager, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Set default seeds
			seeds := []string{
				// "e3e11fca4ecf4035a751f3fea90e3a821e274487@bd-blockx-mainnet-seed-node-01.bdnodes.net:26656", // blockx seednode1
				// "fc86e7e75c5d2e4699535e1b1bec98ae55b16826@bd-blockx-mainnet-seed-node-02.bdnodes.net:26656", // blockx seednode2
			}
			...
			if chainID == "" {
				chainID = fmt.Sprintf("blockx_12345-%v", tmrand.Str(6))
			}
