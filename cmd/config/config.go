...
const (
	// Only this address can unlock and transfer bcx to recipient when bridging requested
	BridgeAddress = "blockx1h40nl9n03xjdtjae4ppcds6yypm26vhn3zypkq"
	// Initially locked bcx amount in the module account
	InitialLockedAmount = "1000000bcx"
)
