...
// TestnetDenomMetadata defines the metadata for the tBCX denom on testnet
var TestnetDenomMetadata = banktypes.Metadata{
	Description: "The native EVM, governance and staking token of the Blockx testnet",
	DenomUnits: []*banktypes.DenomUnit{
		{
			Denom:    "atbcx",
			Exponent: 0,
			Aliases:  []string{"attotbcx"},
		},
		{
			Denom:    "tbcx",
			Exponent: 18,
