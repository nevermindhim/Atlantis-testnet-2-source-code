...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("blockx_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
...
// NewAppConstructor returns a new Blockx AppConstructor
func NewAppConstructor(encodingCfg params.EncodingConfig) AppConstructor {
	return func(val Validator) servertypes.Application {
		return app.NewBlockx(
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "blockxd")
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "blockxcli")
